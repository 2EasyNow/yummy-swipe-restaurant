...
import 'package:intelligent_food_delivery/app/ui/global_widgets/icon_button.dart';
...
import '../../../controllers/core/resturant_owner.controller.dart';
              ...
              children: [
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    final customerController = Get.find<ResturantOwnerController>();
