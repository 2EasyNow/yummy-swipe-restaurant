...
import 'package:intelligent_food_delivery/app/modules/resturant_profile/controllers/resturant_profile_controller.dart';
...
class _ResturantCoordinatesPickerState extends State<ResturantCoordinatesPicker> {
  ...
  Marker? marker;
  final _createAccountController = Get.find<ResturantProfileController>();
                ...
                Positioned(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      controller.resturantCoordinatesController.text = "${target.latitude}, ${target.longitude}";
                      setState(() {
                        marker = Marker(
