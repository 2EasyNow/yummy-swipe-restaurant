...
import 'package:intelligent_food_delivery/app/modules/restaurant_profile/controllers/restaurant_profile_controller.dart';
...
class _RestaurantCoordinatesPickerState extends State<RestaurantCoordinatesPicker> {
  ...
  Marker? marker;
  final _createAccountController = Get.find<RestaurantProfileController>();
  ...
  Widget build(BuildContext context) {
    if (isCurrentLocationFound) {
      return SizedBox(
        height: 100.h,
        width: 100.w,
        child: GetBuilder<RestaurantProfileController>(
          initState: (_) {},
          builder: (controller) {
            return Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      controller.restaurantCoordinatesController.text = "${target.latitude}, ${target.longitude}";
                      setState(() {
                        marker = Marker(
