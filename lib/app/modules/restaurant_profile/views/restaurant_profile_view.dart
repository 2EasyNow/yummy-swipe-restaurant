...
import '../widgets/restaurant_coordinate_picker.dart';

class RestaurantProfileView extends GetView<RestaurantProfileController> {
  RestaurantProfileView({super.key});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            GetBuilder<RestaurantProfileController>(builder: (_) {
              return Expanded(
                child: SingleChildScrollView(
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        // 1. Banner Image
                        // 2. All Restaurant Owner info (name, address, phone number, etc)
                        ...
                        VerticalSpacer(space: 0.5.h),
                        TextFormField(
                          controller: controller.restaurantOwnerNameController,
                        ...
                        VerticalSpacer(space: 0.5.h),
                        TextFormField(
                          controller: controller.restaurantPhoneNumberController,
                        ...
                        VerticalSpacer(space: 0.5.h),
                        TextFormField(
                          controller: controller.restaurantCoordinatesController,
                        ...
                        TextButton.icon(
                          onPressed: () => controller.updateRestaurantInfo(context),
...
class _BannerImage extends StatelessWidget {
  ...
  Future _imagePicker(context) async {
    final ownerUseCase = Get.find<RestaurantUseCase>();
    final controller = Get.find<RestaurantProfileController>();
